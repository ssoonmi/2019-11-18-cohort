...
def my_rotate!(array, amt)
    # array = ["a", "b", "c", "d"]
    num_rotations = amt % array.length
    num_rotations = array.length + num_rotations if amt < 0

    num_rotations.times do
        el = array.shift # 'a'
        array << el # array = ["b", "c", "d", "a"]
    end
    ...
    #     (-amt).times do
    #         el = array.pop # 'd'
    #         array.unshift(el) # array = ["d", "a" "b", "c"]
    #     end
    # end
...
array_1 = ["a", "b", "c", "d"]
p my_rotate!(array_1, 1)
array_1 = ["a", "b", "c", "d"]
p my_rotate!(array_1, 101)
